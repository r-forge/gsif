function [ survival,x_centers,y_centers ] = jointCDF( X,Y,name )
...
%     Y = randn(1,1e5);
    ...
    x_axis = 0:0.05:1; % Define edges of bins for x axis. Column vector
    y_axis = 0:0.05:1; % Same for y axis
...
%     colorbar
%     title 'survival'
%     xlabel('Proportion of Region with High Temperature');
%     ylabel('Proportion of Region with High Precipitation');
